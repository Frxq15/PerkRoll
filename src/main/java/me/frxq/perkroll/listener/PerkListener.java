...
public class PerkListener implements Listener {
    ...
    public void onCurrencyGainBoost(EdPrisonAddMultiplierCurrency event) {
        ...
        Perk boost = (activePerk != null) ? activePerk.getPerk() : null;
        ...
        //Bukkit.broadcastMessage("Boosting "+event.getCurrency()+" gain for " + gPlayer.getName() + ": Original=" + event.getAmount() + ", Boosted=" + total);
    }
}
